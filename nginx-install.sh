...
#名称
softwareName="nginx-1.26.3"
#软件后缀名
softwareSuffix=".tar.gz"

#下载网址
downloadUrl="https://nginx.org/download/nginx-1.26.3.tar.gz"
...
mkdir -p /data/www
mkdir -p /data/www/htdocs/default
mkdir -p /data/www/crontab
mkdir -p /data/www/logs
mkdir -p /data/www/cache
mkdir -p /data/www/tmp

chown -R www:www /data/www
chmod 0755 -R /data/www
chmod 0775 -R /data/www/logs

mkdir -m 0777 -p /var/log/nginx /data/www/logs/nginx
chown www.www -R /var/log/nginx /data/www/logs/nginx

mkdir -m 0777 -p /data/www/cache/nginx_proxy_cache /data/www/cache/nginx_proxy_temp
chown www.www -R /data/www/cache/nginx_proxy_cache /data/www/cache/nginx_proxy_temp
...
http {
	...
	access_log off;	
	error_log  /data/www/logs/nginx/error.log  warn;
	...
	server {
		...
		#access_log  /data/www/logs/nginx/mydomain_access.log  main buffer=16k;
		#error_log  /data/www/logs/nginx/mydomain_error.log  warn;
	}

...
#名称
softwareName="freetype-2.13.3"
#软件后缀名
softwareSuffix=".tar.gz"

#下载网址
downloadUrl="http://download.savannah.gnu.org/releases/freetype/freetype-2.13.3.tar.gz"
#安装路径
targetPath="/usr/local"

#校验文件
verifiedFilePath="/usr/local/lib/libfreetype.so"
...
#删除yum安装过的软件旧版本
#yum -y remove freetype freetype-devel

...
#名称
softwareName="rpcsvc-proto-1.4.2"
#软件后缀名
softwareSuffix=".tar.xz"

#下载网址
downloadUrl="https://github.com/thkukuk/rpcsvc-proto/releases/download/v1.4.2/rpcsvc-proto-1.4.2.tar.xz"
#安装路径
targetPath="/usr/local"

#校验文件
verifiedFilePath="/usr/local/bin/rpcgen"

...
#名称
softwareName="cmake-3.31.5"
#软件后缀名
softwareSuffix=".tar.gz"

#下载网址
downloadUrl="https://github.com/Kitware/CMake/releases/download/v3.31.5/cmake-3.31.5.tar.gz"
#安装路径
targetPath="/usr/local"

#校验文件
verifiedFilePath="/usr/local/bin/cmake"
...
cd $softwareName
./bootstrap --prefix=$targetPath --datadir=share/cmake --docdir=doc/cmake
make
